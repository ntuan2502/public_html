...
<meta property="og:title" content="Patch Note" />
<meta property="og:description" content="" />
<meta property="og:image" content="{{$vsp_background->value}}" />

@endsection
@section('body')

<div class="bradcam_area" style="background-image: url({{$vsp_background->value}}); background-position: unset;">
   <div class="container">
      <div class="row">
         <div class="col-xl-12">
